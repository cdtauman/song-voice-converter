...
> **מצב הפרויקט:** Phase 6 הושלם ברמת המימוש — הצינור המלא כולל PostFX ומאסטר.
...
> מרחב A/B/C, `loudnorm`/`alimiter` דרך ffmpeg וייצוא WAV/MP3. הכרעת האיכות הסופית
...
1. **לאסוף את חומרי הבדיקה** — 5 שירים, 2 קטעי ווקאל יבשים, ו-3 קולות יעד
   ...
   של Phase 2, 3 ו-4.
2. לאמת את Phase 5 על החומרים שנאספו, ואז להריץ את מטריצת Raw/A/B/C של
