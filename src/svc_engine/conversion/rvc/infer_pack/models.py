...
file `infer/module/models.py`. Imports were repointed to this package and training-only
...
from svc_engine.conversion.rvc.infer_pack import attentions, commons, modules
