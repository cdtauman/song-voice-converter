...
>
> **עדכון Phase 9:** נוספו לקטלוג `rvc_training_runtime` (ContentVec + RMVPE,
> MIT) ו-`titan_medium_48k` (TITAN Medium 48k, Apache-2.0). כל חמשת הקבצים
> נעולים בגודל וב-SHA-256 מול revisions קבועים. קוד Applio עצמו נעול בנפרד
> לקומיט וב-hash של ארכיון המקור; ראה [third-party.md §1.2](third-party.md).
...
- **תוספת אימון מקומי:** ContentVec/RMVPE + TITAN Medium 48k ≈ **1.8GB**
- **התקנה מלאה (כל המודלים):** ≈ **5.3GB**
